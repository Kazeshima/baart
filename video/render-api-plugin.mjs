...
import { applyJobProgress, cancelJob, isActiveRenderStatus } from "./core/renderJob.js";
          ...
          if (request.method === "POST" && url.pathname === "/api/render") {
            ...
            renderVideoProject(project, {
              ...
              onBrowserDownload: progress => {
                if (!job.cancelRequested) job.browserDownload = { percent: Math.max(0, Math.min(100, progress.percent || 0)), alreadyAvailable: progress.alreadyAvailable };
              },
