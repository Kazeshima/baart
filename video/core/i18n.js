const TEXT = {
  zh: {
    ...
    preset: "分辨率", format: "格式", filename: "文件名", renderConcurrency: "渲染并行度", auto: "自动",
  ...
  en: {
    ...
    preset: "Preset", format: "Format", filename: "Filename", renderConcurrency: "Render concurrency", auto: "Auto",
