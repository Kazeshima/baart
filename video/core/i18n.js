const TEXT = {
  zh: {
    ...
    bottleneckDiskIo: "磁盘写入", bottleneckBrowserPng: "浏览器渲染或 PNG 编码", bottleneckUnknown: "未知",
    pngSequence: "PNG 图片序列", outputLocation: "保存位置",
  ...
  en: {
    ...
    bottleneckDiskIo: "Disk IO", bottleneckBrowserPng: "Browser render or PNG encoding", bottleneckUnknown: "Unknown",
    pngSequence: "PNG sequence", outputLocation: "Save location",
