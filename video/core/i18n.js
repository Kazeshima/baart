const TEXT = {
  zh: {
    ...
    fadeOut: "淡出（秒）", infoStagger: "信息块间隔（秒）", radarAxisStep: "雷达轴速度（秒）",
    radarDataStep: "数据点速度（秒）", polygonReveal: "多边形显示（秒）", overallReveal: "综合评级显示（秒）",
    ...
    chronological: "评级时间", studentId: "学生 ID", school: "学校分组", manual: "手动排序",
  ...
  en: {
    ...
    fadeOut: "Fade out (s)", infoStagger: "Info stagger (s)", radarAxisStep: "Radar axis step (s)",
    radarDataStep: "Radar data step (s)", polygonReveal: "Polygon reveal (s)", overallReveal: "Overall reveal (s)",
    ...
    chronological: "Chronological", studentId: "Student ID", school: "School", manual: "Manual",
