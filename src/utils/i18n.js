...
export const UI_TEXT = {
  zh: {
    ...
    batchExport: "批量导出ZIP",
    videoStudio: "视频工作室",
    dimensionRankReport: "维度排名",
    dimensionRankHint: "按单个维度检查学生评分顺序是否一致",
    theme: "主题",
    darkTheme: "夜间",
    lightTheme: "白底",
    saveJson: "保存JSON",
    ...
    manual: "手动",
    scoreWeight: "造价权重",
    dimensionWeight: "权重占比",
    weightMode: "权重模式",
    weightEditorMode: "编辑方式",
    fineWeights: "精细百分比",
    presetWeights: "预设权重",
    sharedWeights: "全体共用",
    individualWeights: "单独设置",
    unassignedWeight: "未分配权重",
    incompleteWeights: "还有未分配权重，自动综合分与导出/视频渲染会暂时禁用。",
    weightsUsed: "计分权重占比",
    costNone: "不计",
    costHalf: "半权重",
    costFull: "全权重",
    ...
    autoExplain: "根据五维评分和归一化权重占比自动生成",
  ...
  en: {
    ...
    dimensionRankReport: "Dimension Ranks",
    dimensionRankHint: "Check whether ratings are consistent within one dimension",
    theme: "Theme",
    darkTheme: "Night",
    lightTheme: "Day",
    saveJson: "Save JSON",
    ...
    dimensionWeight: "Weight Share",
    weightMode: "Weight Mode",
    weightEditorMode: "Edit Mode",
    fineWeights: "Fine Percentages",
    presetWeights: "Preset Weights",
    sharedWeights: "Shared",
    individualWeights: "Individual",
    unassignedWeight: "Unassigned Weight",
    incompleteWeights: "Unassigned weight remains. Auto overall, card export, and video rendering are temporarily disabled.",
    weightsUsed: "Score Weight Shares",
    costNone: "Exclude",
    costHalf: "Half",
    costFull: "Full",
    notes: "Notes",
    ...
    autoExplain: "Generated from dimension scores and normalized weight shares",
